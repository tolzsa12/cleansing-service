...
## Function 5: Split Column แยกคอลัมน์
ในฟังก์ชันนี้จะทำการแยกคอลัมน์ตามตัวแบ่ง (Delimeter) ตามที่ผู้ใช้กำหนด โดยจะไม่ทำการลบคอลัมน์ที่ถูกแบ่งไป เช่น มีคอลัมน์ "Date" ข้อมูลตัวอย่างเช่น "18/02/2566"
กำหนดค่า "column_1" : "Day", "column_2" = "Month", "delimeter" = "/"
จะได้ json ที่มีค่า
"Date" : "18/02/2566",
"Day" : "18",
...
- addition :
    ...
    "delimeter" : "ตัวแบ่งที่ผู้ใช้กำหนด"
...
## Function 9: Remove Outliers ลบค่าข้อมูลที่ผิดปกติทางสถิติ
...
## Function 10: Change Outliers เปลี่ยนค่าข้อมูลที่ผิดปกติทางสถิติ
